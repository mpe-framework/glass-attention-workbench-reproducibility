...
substitution, and a causal/diagnostic head distinction --- in a transparent toy
model where all parameters are designed.
...
\begin{itemize}
  ...
  \item \textbf{G-track as proof of the T5-small mechanism.}
    G-track results are established in controlled toy geometry with engineered
    embeddings.
