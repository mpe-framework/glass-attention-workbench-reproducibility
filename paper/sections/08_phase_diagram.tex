...
The G-track is a series of controlled toy experiments that demonstrate accessible
...
\caption{Born filter three-regime phase diagram (G-054). Controlled G-track
...
\begin{itemize}
  ...
  \item \textbf{Quantitative correspondence between G-track and S-track values.}
    The G-track uses engineered embeddings, fixed seeds, and fully specified parameters.
  ...
  \item \textbf{Generalization to other trained architectures.}
    G-track results are established in controlled toy geometry.
