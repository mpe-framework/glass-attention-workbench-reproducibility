...
BACKGROUND:
  ...
  Intervention arms:
    ...
    Arm D  — neutralize L3H4 (suppressive-head control per [internal dev-file path removed in public export])
...
L3H4 = (2, 4, "L3H4")   # suppressive-head control ([internal dev-file path removed in public export] / S-057)
